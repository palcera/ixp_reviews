...
ixp_radix theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of ixp_radix theme and run the following commands:
`nvm use`
...
`drush en ixp_radix -y`
`drush config-set system.theme default ixp_radix -y`
